...
from app.services.budget_service import BudgetService, BudgetPeriod, EnforcementMode, BudgetExceededException
...
class TestBillingIntegration:
    ...
    def setup_method(self):
        ...
        self.mock_agent = models.Agent(id=self.agent_id, org_id=self.org_id, display_name="Test Agent")
    ...
    async def test_complete_billing_flow(self):
        ...
        assert hasattr(updated_budget, "current_usage_cents") and updated_budget.current_usage_cents >= 0
    ...
    async def test_usage_reporting_to_provider(self):
        ...
        self.mock_db.query.return_value.filter.return_value.first.return_value = subscription
    ...
    async def test_webhook_processing(self):
        ...
        self.mock_db.query.return_value.filter.return_value.first.return_value = billing_customer
    ...
    async def test_checkout_session_creation(self):
        ...
        self.mock_provider._customers[billing_customer.external_customer_id] = \
            self.mock_provider._customers.get(billing_customer.external_customer_id) or \
            type(self.mock_provider).create_customer.__annotations__.get('return', None)
