...
class BudgetSchedulerService:
    ...
    def setup_jobs(self):
        ...
        self.scheduler.add_job(
            func=self.check_budget_violations,
        ...
        self.scheduler.add_job(
            func=self.check_budget_warnings,
        ...
        self.scheduler.add_job(
            func=self.reset_weekly_budgets,
        ...
        self.scheduler.add_job(
            func=self.reset_monthly_budgets,
        ...
        self.scheduler.add_job(
            func=self.cleanup_old_usage_records,
