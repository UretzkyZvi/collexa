...
class TestRefactoredServices:
    ...
    async def test_checkout_service_isolation(self):
        ...
        with patch.object(checkout_service.customer_service, 'get_or_create_customer_for_org') as mock_get_customer:
            ...
            self.mock_provider._customers[mock_billing_customer.external_customer_id] = Customer(
    ...
    def test_budget_enforcement_service_isolation(self):
        ...
        # Mock database query
        self.mock_db.query.return_value.filter.return_value.all.return_value = [mock_budget]
