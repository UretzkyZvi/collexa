...
from app.services.sandbox_orchestrator import orchestrator, SandboxRequest, ServiceConfig
...
class SandboxDomainService:
    ...
    async def create_sandbox(
        ...
        try:
            sandbox_info = await orchestrator.create_sandbox(agent_id, orchestrator_request)
    ...
    def _convert_to_orchestrator_request(self, request: CreateSandboxRequest) -> SandboxRequest:
    ...
    def _convert_to_response(self, sandbox_info, ttl_minutes: Optional[int] = None) -> SandboxResponse:
