...
def set_request_context(request_id: str, org_id: Optional[str] = None, agent_id: Optional[str] = None):
...
def log_agent_invocation(logger: logging.Logger, agent_id: str, capability: str, 
